  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      >
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-2">Global Appointments</h2>
        <p className="text-gray-500 max-w-md">
          Monitor all platform appointments, handle disputes, and oversee scheduling operations. (Coming Soon)
        </p>
      </motion.div>
    </div>
  );
