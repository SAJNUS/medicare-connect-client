  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      >
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-2">Digital Prescriptions</h2>
        <p className="text-gray-500 max-w-md">
          Create, edit, and send digital prescriptions directly to your patients. (Coming Soon)
        </p>
      </motion.div>
    </div>
  );
