      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#0b6e66] rounded-3xl overflow-hidden relative shadow-xl">
          <div className="flex flex-col lg:flex-row items-center">
            ...
            {/* Content Side */}
            <div className="w-full lg:w-2/3 p-8 lg:p-12 flex flex-col lg:flex-row items-center justify-between z-10 relative">
              <div className="text-center lg:text-left mb-8 lg:mb-0 lg:mr-8">
                <motion.h2 
                  className="text-2xl md:text-3xl font-poppins font-bold text-white mb-3 leading-tight"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                >
                  Need Immediate<br />Medical Assistance?
                </motion.h2>
                <motion.p 
